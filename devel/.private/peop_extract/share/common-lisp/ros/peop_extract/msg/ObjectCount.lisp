...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCount>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCount)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name peop_extract-msg:<ObjectCount> is deprecated: use peop_extract-msg:ObjectCount instead.")))
...
(cl:defmethod count-val ((m <ObjectCount>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader peop_extract-msg:count-val is deprecated.  Use peop_extract-msg:count instead.")
  (count m))
