...
(cl:defmethod cl:initialize-instance :after ((m <people_box>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'people_box)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name peop_extract-msg:<people_box> is deprecated: use peop_extract-msg:people_box instead.")))
...
(cl:defmethod area-val ((m <people_box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader peop_extract-msg:area-val is deprecated.  Use peop_extract-msg:area instead.")
  (area m))
