...
"""autogenerated by genpy from peop_extract/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxes(genpy.Message):
  ...
  _type = "peop_extract/BoundingBoxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','peop_extract/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = peop_extract.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
