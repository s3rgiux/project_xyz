...
(cl:defclass <Obstacles> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (segments
    :reader segments
    :initarg :segments
    :type (cl:vector segement_obstacle_danger-msg:SegmentObstacle)
   :initform (cl:make-array 0 :element-type 'segement_obstacle_danger-msg:SegmentObstacle :initial-element (cl:make-instance 'segement_obstacle_danger-msg:SegmentObstacle)))
   (circles
    :reader circles
    :initarg :circles
    :type (cl:vector segement_obstacle_danger-msg:CircleObstacle)
   :initform (cl:make-array 0 :element-type 'segement_obstacle_danger-msg:CircleObstacle :initial-element (cl:make-instance 'segement_obstacle_danger-msg:CircleObstacle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Obstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segement_obstacle_danger-msg:<Obstacles> is deprecated: use segement_obstacle_danger-msg:Obstacles instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:header-val is deprecated.  Use segement_obstacle_danger-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'segments-val :lambda-list '(m))
(cl:defmethod segments-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:segments-val is deprecated.  Use segement_obstacle_danger-msg:segments instead.")
  (segments m))

(cl:ensure-generic-function 'circles-val :lambda-list '(m))
(cl:defmethod circles-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:circles-val is deprecated.  Use segement_obstacle_danger-msg:circles instead.")
  (circles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Obstacles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'segments)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'segement_obstacle_danger-msg:SegmentObstacle))
  ...
  (cl:let ((vals (cl:slot-value msg 'circles)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'segement_obstacle_danger-msg:CircleObstacle))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Obstacles>)))
  ...
  "segement_obstacle_danger/Obstacles")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Obstacles)))
  "Returns string type for a message object of type 'Obstacles"
  "segement_obstacle_danger/Obstacles")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Obstacles>)))
  ...
  (cl:format cl:nil "Header header~%~%SegmentObstacle[] segments~%CircleObstacle[] circles~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: segement_obstacle_danger/SegmentObstacle~%geometry_msgs/Point first_point  # First point of the segment [m]~%geometry_msgs/Point last_point   # Last point of the segment [m]~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: segement_obstacle_danger/CircleObstacle~%geometry_msgs/Point center      # Central point [m]~%geometry_msgs/Vector3 velocity  # Linear velocity [m/s]~%float64 radius                  # Radius with added margin [m]~%float64 true_radius             # True measured radius [m]~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Obstacles)))
  "Returns full string definition for message of type 'Obstacles"
  (cl:format cl:nil "Header header~%~%SegmentObstacle[] segments~%CircleObstacle[] circles~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: segement_obstacle_danger/SegmentObstacle~%geometry_msgs/Point first_point  # First point of the segment [m]~%geometry_msgs/Point last_point   # Last point of the segment [m]~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: segement_obstacle_danger/CircleObstacle~%geometry_msgs/Point center      # Central point [m]~%geometry_msgs/Vector3 velocity  # Linear velocity [m/s]~%float64 radius                  # Radius with added margin [m]~%float64 true_radius             # True measured radius [m]~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
