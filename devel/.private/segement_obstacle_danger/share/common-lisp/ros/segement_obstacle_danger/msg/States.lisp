...
(cl:defmethod cl:initialize-instance :after ((m <States>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'States)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segement_obstacle_danger-msg:<States> is deprecated: use segement_obstacle_danger-msg:States instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state-val is deprecated.  Use segement_obstacle_danger-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'state_karugamo-val :lambda-list '(m))
(cl:defmethod state_karugamo-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_karugamo-val is deprecated.  Use segement_obstacle_danger-msg:state_karugamo instead.")
  (state_karugamo m))

(cl:ensure-generic-function 'state_collision-val :lambda-list '(m))
(cl:defmethod state_collision-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_collision-val is deprecated.  Use segement_obstacle_danger-msg:state_collision instead.")
  (state_collision m))

(cl:ensure-generic-function 'state_danger-val :lambda-list '(m))
(cl:defmethod state_danger-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_danger-val is deprecated.  Use segement_obstacle_danger-msg:state_danger instead.")
  (state_danger m))

(cl:ensure-generic-function 'state_costmap-val :lambda-list '(m))
(cl:defmethod state_costmap-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_costmap-val is deprecated.  Use segement_obstacle_danger-msg:state_costmap instead.")
  (state_costmap m))

(cl:ensure-generic-function 'state_manual-val :lambda-list '(m))
(cl:defmethod state_manual-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_manual-val is deprecated.  Use segement_obstacle_danger-msg:state_manual instead.")
  (state_manual m))

(cl:ensure-generic-function 'state_scan-val :lambda-list '(m))
(cl:defmethod state_scan-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_scan-val is deprecated.  Use segement_obstacle_danger-msg:state_scan instead.")
  (state_scan m))

(cl:ensure-generic-function 'state_load-val :lambda-list '(m))
(cl:defmethod state_load-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_load-val is deprecated.  Use segement_obstacle_danger-msg:state_load instead.")
  (state_load m))

(cl:ensure-generic-function 'state_shelf-val :lambda-list '(m))
(cl:defmethod state_shelf-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_shelf-val is deprecated.  Use segement_obstacle_danger-msg:state_shelf instead.")
  (state_shelf m))

(cl:ensure-generic-function 'state_navigation-val :lambda-list '(m))
(cl:defmethod state_navigation-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:state_navigation-val is deprecated.  Use segement_obstacle_danger-msg:state_navigation instead.")
  (state_navigation m))

(cl:ensure-generic-function 'costmap-val :lambda-list '(m))
(cl:defmethod costmap-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:costmap-val is deprecated.  Use segement_obstacle_danger-msg:costmap instead.")
  (costmap m))

(cl:ensure-generic-function 'side_joystick-val :lambda-list '(m))
(cl:defmethod side_joystick-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:side_joystick-val is deprecated.  Use segement_obstacle_danger-msg:side_joystick instead.")
  (side_joystick m))

(cl:ensure-generic-function 'ctrl_front-val :lambda-list '(m))
(cl:defmethod ctrl_front-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:ctrl_front-val is deprecated.  Use segement_obstacle_danger-msg:ctrl_front instead.")
  (ctrl_front m))

(cl:ensure-generic-function 'ctrl_side-val :lambda-list '(m))
(cl:defmethod ctrl_side-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:ctrl_side-val is deprecated.  Use segement_obstacle_danger-msg:ctrl_side instead.")
  (ctrl_side m))

(cl:ensure-generic-function 'trackeds-val :lambda-list '(m))
(cl:defmethod trackeds-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:trackeds-val is deprecated.  Use segement_obstacle_danger-msg:trackeds instead.")
  (trackeds m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<States>)))
  ...
  "segement_obstacle_danger/States")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'States)))
  "Returns string type for a message object of type 'States"
  "segement_obstacle_danger/States")
