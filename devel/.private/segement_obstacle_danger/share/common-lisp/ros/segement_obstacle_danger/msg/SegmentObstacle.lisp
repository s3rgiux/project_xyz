...
(cl:defmethod cl:initialize-instance :after ((m <SegmentObstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SegmentObstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segement_obstacle_danger-msg:<SegmentObstacle> is deprecated: use segement_obstacle_danger-msg:SegmentObstacle instead.")))

(cl:ensure-generic-function 'first_point-val :lambda-list '(m))
(cl:defmethod first_point-val ((m <SegmentObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:first_point-val is deprecated.  Use segement_obstacle_danger-msg:first_point instead.")
  (first_point m))

(cl:ensure-generic-function 'last_point-val :lambda-list '(m))
(cl:defmethod last_point-val ((m <SegmentObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:last_point-val is deprecated.  Use segement_obstacle_danger-msg:last_point instead.")
  (last_point m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SegmentObstacle>)))
  ...
  "segement_obstacle_danger/SegmentObstacle")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SegmentObstacle)))
  "Returns string type for a message object of type 'SegmentObstacle"
  "segement_obstacle_danger/SegmentObstacle")
