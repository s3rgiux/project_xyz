...
(cl:defmethod cl:initialize-instance :after ((m <CircleObstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CircleObstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name segement_obstacle_danger-msg:<CircleObstacle> is deprecated: use segement_obstacle_danger-msg:CircleObstacle instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:center-val is deprecated.  Use segement_obstacle_danger-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:velocity-val is deprecated.  Use segement_obstacle_danger-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:radius-val is deprecated.  Use segement_obstacle_danger-msg:radius instead.")
  (radius m))

(cl:ensure-generic-function 'true_radius-val :lambda-list '(m))
(cl:defmethod true_radius-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segement_obstacle_danger-msg:true_radius-val is deprecated.  Use segement_obstacle_danger-msg:true_radius instead.")
  (true_radius m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CircleObstacle>)))
  ...
  "segement_obstacle_danger/CircleObstacle")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CircleObstacle)))
  "Returns string type for a message object of type 'CircleObstacle"
  "segement_obstacle_danger/CircleObstacle")
