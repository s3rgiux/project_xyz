// Generated by gencpp from file segement_obstacle_danger/States.msg
// DO NOT EDIT!


#ifndef SEGEMENT_OBSTACLE_DANGER_MESSAGE_STATES_H
#define SEGEMENT_OBSTACLE_DANGER_MESSAGE_STATES_H
...
struct States_
{
  ...
  typedef boost::shared_ptr< ::segement_obstacle_danger::States_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::segement_obstacle_danger::States_<ContainerAllocator> const> ConstPtr;

}; // struct States_

typedef ::segement_obstacle_danger::States_<std::allocator<void> > States;

typedef boost::shared_ptr< ::segement_obstacle_danger::States > StatesPtr;
typedef boost::shared_ptr< ::segement_obstacle_danger::States const> StatesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::segement_obstacle_danger::States_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::segement_obstacle_danger::States_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::segement_obstacle_danger::States_<ContainerAllocator1> & lhs, const ::segement_obstacle_danger::States_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::segement_obstacle_danger::States_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::segement_obstacle_danger::States_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::segement_obstacle_danger::States_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::segement_obstacle_danger::States_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::segement_obstacle_danger::States_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::segement_obstacle_danger::States_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::segement_obstacle_danger::States_<ContainerAllocator> >
{
  ...
  static const char* value(const ::segement_obstacle_danger::States_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x020c7260fce8cdbdULL;
  static const uint64_t static_value2 = 0x7570da53eb117321ULL;
};

template<class ContainerAllocator>
struct DataType< ::segement_obstacle_danger::States_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::segement_obstacle_danger::States_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string state\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::segement_obstacle_danger::States_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::segement_obstacle_danger::States_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::segement_obstacle_danger::States_<ContainerAllocator>& v)
  {
    s << indent << "state: ";
...
#endif // SEGEMENT_OBSTACLE_DANGER_MESSAGE_STATES_H
