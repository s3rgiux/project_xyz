// Generated by gencpp from file control_xy/TriggerAction.msg
// DO NOT EDIT!


#ifndef CONTROL_XY_MESSAGE_TRIGGERACTION_H
#define CONTROL_XY_MESSAGE_TRIGGERACTION_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::control_xy::TriggerAction_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::control_xy::TriggerAction_<ContainerAllocator> const> ConstPtr;

}; // struct TriggerAction_

typedef ::control_xy::TriggerAction_<std::allocator<void> > TriggerAction;

typedef boost::shared_ptr< ::control_xy::TriggerAction > TriggerActionPtr;
typedef boost::shared_ptr< ::control_xy::TriggerAction const> TriggerActionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::control_xy::TriggerAction_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::control_xy::TriggerAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::control_xy::TriggerAction_<ContainerAllocator1> & lhs, const ::control_xy::TriggerAction_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::control_xy::TriggerAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::control_xy::TriggerAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::control_xy::TriggerAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::control_xy::TriggerAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::control_xy::TriggerAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::control_xy::TriggerAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::control_xy::TriggerAction_<ContainerAllocator> >
{
  ...
  static const char* value(const ::control_xy::TriggerAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x529f37831afe7067ULL;
  static const uint64_t static_value2 = 0x075cb584db0e391eULL;
};

template<class ContainerAllocator>
struct DataType< ::control_xy::TriggerAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::control_xy::TriggerAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# 非常停止ボタン解除\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::control_xy::TriggerAction_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::control_xy::TriggerAction_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::control_xy::TriggerAction_<ContainerAllocator>& v)
  {
    s << indent << "trigger: ";
...
#endif // CONTROL_XY_MESSAGE_TRIGGERACTION_H
