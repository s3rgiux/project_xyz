...
(cl:defmethod cl:initialize-instance :after ((m <TriggerAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TriggerAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_xy-msg:<TriggerAction> is deprecated: use control_xy-msg:TriggerAction instead.")))

(cl:ensure-generic-function 'trigger-val :lambda-list '(m))
(cl:defmethod trigger-val ((m <TriggerAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_xy-msg:trigger-val is deprecated.  Use control_xy-msg:trigger instead.")
  (trigger m))
