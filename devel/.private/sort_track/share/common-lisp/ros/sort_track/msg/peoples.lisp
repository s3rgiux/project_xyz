...
(cl:defclass <peoples> (roslisp-msg-protocol:ros-message)
  ((people
    :reader people
    :initarg :people
    :type (cl:vector sort_track-msg:people_box)
   :initform (cl:make-array 0 :element-type 'sort_track-msg:people_box :initial-element (cl:make-instance 'sort_track-msg:people_box))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <peoples>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'peoples)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sort_track-msg:<peoples> is deprecated: use sort_track-msg:peoples instead.")))

(cl:ensure-generic-function 'people-val :lambda-list '(m))
(cl:defmethod people-val ((m <peoples>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sort_track-msg:people-val is deprecated.  Use sort_track-msg:people instead.")
  (people m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <peoples>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'people)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sort_track-msg:people_box))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<peoples>)))
  ...
  (cl:format cl:nil "sort_track/people_box[] people~%~%================================================================================~%MSG: sort_track/people_box~%int16 xmin~%int16 ymin~%int16 xmax~%int16 ymax~%int16 id~%int16 area~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'peoples)))
  "Returns full string definition for message of type 'peoples"
  (cl:format cl:nil "sort_track/people_box[] people~%~%================================================================================~%MSG: sort_track/people_box~%int16 xmin~%int16 ymin~%int16 xmax~%int16 ymax~%int16 id~%int16 area~%~%~%"))
