...
"""autogenerated by genpy from map_msgs/GetMapROIRequest.msg. Do not edit."""
import sys
...
class GetMapROIRequest(genpy.Message):
  _md5sum = "43c2ff8f45af555c0eaf070c401e9a47"
  _type = "map_msgs/GetMapROIRequest"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.l_x, _x.l_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.l_x, _x.l_y,) = _get_struct_4d().unpack(str[start:end])
      return self
...
def _get_struct_4d():
    ...
    return _struct_4d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from map_msgs/GetMapROIResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetMapROIResponse(genpy.Message):
  _md5sum = "4d1986519c00d81967d2891a606b234c"
  _type = "map_msgs/GetMapROIResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """nav_msgs/OccupancyGrid sub_map
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sub_map.info.map_load_time.secs, _x.sub_map.info.map_load_time.nsecs, _x.sub_map.info.resolution, _x.sub_map.info.width, _x.sub_map.info.height, _x.sub_map.info.origin.position.x, _x.sub_map.info.origin.position.y, _x.sub_map.info.origin.position.z, _x.sub_map.info.origin.orientation.x, _x.sub_map.info.origin.orientation.y, _x.sub_map.info.origin.orientation.z, _x.sub_map.info.origin.orientation.w,) = _get_struct_2If2I7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.sub_map.data = struct.unpack(pattern, str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(self.sub_map.data.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.sub_map.data = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class GetMapROI(object):
  _type          = 'map_msgs/GetMapROI'
  _md5sum = '81aa75ecf00f4571a9be0d9dc6dea512'
