...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.controller = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.planner = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.final_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_feedback.feedback.last_cmd_vel.header.frame_id = str[start:end].decode('utf-8')
      else:
