...
(cl:defclass <Obstacles> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (segments
    :reader segments
    :initarg :segments
    :type (cl:vector obs_extract-msg:SegmentObstacle)
   :initform (cl:make-array 0 :element-type 'obs_extract-msg:SegmentObstacle :initial-element (cl:make-instance 'obs_extract-msg:SegmentObstacle)))
   (circles
    :reader circles
    :initarg :circles
    :type (cl:vector obs_extract-msg:CircleObstacle)
   :initform (cl:make-array 0 :element-type 'obs_extract-msg:CircleObstacle :initial-element (cl:make-instance 'obs_extract-msg:CircleObstacle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Obstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obs_extract-msg:<Obstacles> is deprecated: use obs_extract-msg:Obstacles instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:header-val is deprecated.  Use obs_extract-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'segments-val :lambda-list '(m))
(cl:defmethod segments-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:segments-val is deprecated.  Use obs_extract-msg:segments instead.")
  (segments m))

(cl:ensure-generic-function 'circles-val :lambda-list '(m))
(cl:defmethod circles-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:circles-val is deprecated.  Use obs_extract-msg:circles instead.")
  (circles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Obstacles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'segments)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'obs_extract-msg:SegmentObstacle))
  ...
  (cl:let ((vals (cl:slot-value msg 'circles)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'obs_extract-msg:CircleObstacle))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
