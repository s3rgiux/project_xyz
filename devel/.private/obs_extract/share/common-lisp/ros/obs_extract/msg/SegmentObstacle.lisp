...
(cl:defmethod cl:initialize-instance :after ((m <SegmentObstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SegmentObstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obs_extract-msg:<SegmentObstacle> is deprecated: use obs_extract-msg:SegmentObstacle instead.")))

(cl:ensure-generic-function 'first_point-val :lambda-list '(m))
(cl:defmethod first_point-val ((m <SegmentObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:first_point-val is deprecated.  Use obs_extract-msg:first_point instead.")
  (first_point m))

(cl:ensure-generic-function 'last_point-val :lambda-list '(m))
(cl:defmethod last_point-val ((m <SegmentObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:last_point-val is deprecated.  Use obs_extract-msg:last_point instead.")
  (last_point m))
