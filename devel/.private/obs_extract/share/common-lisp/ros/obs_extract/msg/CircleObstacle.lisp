...
(cl:defmethod cl:initialize-instance :after ((m <CircleObstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CircleObstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obs_extract-msg:<CircleObstacle> is deprecated: use obs_extract-msg:CircleObstacle instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:center-val is deprecated.  Use obs_extract-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:velocity-val is deprecated.  Use obs_extract-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:radius-val is deprecated.  Use obs_extract-msg:radius instead.")
  (radius m))

(cl:ensure-generic-function 'true_radius-val :lambda-list '(m))
(cl:defmethod true_radius-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:true_radius-val is deprecated.  Use obs_extract-msg:true_radius instead.")
  (true_radius m))
