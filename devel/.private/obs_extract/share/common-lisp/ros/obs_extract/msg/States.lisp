...
(cl:defmethod state_load-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:state_load-val is deprecated.  Use obs_extract-msg:state_load instead.")
  (state_load m))

(cl:ensure-generic-function 'state_shelf-val :lambda-list '(m))
(cl:defmethod state_shelf-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:state_shelf-val is deprecated.  Use obs_extract-msg:state_shelf instead.")
  (state_shelf m))

(cl:ensure-generic-function 'state_navigation-val :lambda-list '(m))
(cl:defmethod state_navigation-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:state_navigation-val is deprecated.  Use obs_extract-msg:state_navigation instead.")
  (state_navigation m))

(cl:ensure-generic-function 'costmap-val :lambda-list '(m))
(cl:defmethod costmap-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:costmap-val is deprecated.  Use obs_extract-msg:costmap instead.")
  (costmap m))

(cl:ensure-generic-function 'side_joystick-val :lambda-list '(m))
(cl:defmethod side_joystick-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:side_joystick-val is deprecated.  Use obs_extract-msg:side_joystick instead.")
  (side_joystick m))

(cl:ensure-generic-function 'ctrl_front-val :lambda-list '(m))
(cl:defmethod ctrl_front-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:ctrl_front-val is deprecated.  Use obs_extract-msg:ctrl_front instead.")
  (ctrl_front m))

(cl:ensure-generic-function 'ctrl_side-val :lambda-list '(m))
(cl:defmethod ctrl_side-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_extract-msg:ctrl_side-val is deprecated.  Use obs_extract-msg:ctrl_side instead.")
  (ctrl_side m))
