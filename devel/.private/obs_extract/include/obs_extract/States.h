// Generated by gencpp from file obs_extract/States.msg
// DO NOT EDIT!


#ifndef OBS_EXTRACT_MESSAGE_STATES_H
#define OBS_EXTRACT_MESSAGE_STATES_H
...
struct States_
{
  ...
  typedef boost::shared_ptr< ::obs_extract::States_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::obs_extract::States_<ContainerAllocator> const> ConstPtr;

}; // struct States_

typedef ::obs_extract::States_<std::allocator<void> > States;

typedef boost::shared_ptr< ::obs_extract::States > StatesPtr;
typedef boost::shared_ptr< ::obs_extract::States const> StatesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::obs_extract::States_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::obs_extract::States_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::obs_extract::States_<ContainerAllocator1> & lhs, const ::obs_extract::States_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::obs_extract::States_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::obs_extract::States_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::obs_extract::States_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::obs_extract::States_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::obs_extract::States_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::obs_extract::States_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::obs_extract::States_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::obs_extract::States_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::obs_extract::States_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string state\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::obs_extract::States_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::obs_extract::States_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::obs_extract::States_<ContainerAllocator>& v)
  {
    s << indent << "state: ";
...
#endif // OBS_EXTRACT_MESSAGE_STATES_H
