...
"""autogenerated by genpy from obs_extract/Obstacles.msg. Do not edit."""
import codecs
import sys
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','obs_extract/SegmentObstacle[]','obs_extract/CircleObstacle[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = obs_extract.msg.SegmentObstacle()
      ...
      self.circles = []
      for i in range(0, length):
        val1 = obs_extract.msg.CircleObstacle()
        _v7 = val1.center
        _x = _v7
        start = end
        end += 24
