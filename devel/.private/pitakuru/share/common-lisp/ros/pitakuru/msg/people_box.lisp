...
(cl:defmethod cl:initialize-instance :after ((m <people_box>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'people_box)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pitakuru-msg:<people_box> is deprecated: use pitakuru-msg:people_box instead.")))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <people_box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:xmin-val is deprecated.  Use pitakuru-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <people_box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:ymin-val is deprecated.  Use pitakuru-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <people_box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:xmax-val is deprecated.  Use pitakuru-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <people_box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:ymax-val is deprecated.  Use pitakuru-msg:ymax instead.")
  (ymax m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <people_box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:id-val is deprecated.  Use pitakuru-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'area-val :lambda-list '(m))
(cl:defmethod area-val ((m <people_box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:area-val is deprecated.  Use pitakuru-msg:area instead.")
  (area m))
