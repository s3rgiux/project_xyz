...
(cl:defmethod state_manual-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:state_manual-val is deprecated.  Use pitakuru-msg:state_manual instead.")
  (state_manual m))

(cl:ensure-generic-function 'state_scan-val :lambda-list '(m))
(cl:defmethod state_scan-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:state_scan-val is deprecated.  Use pitakuru-msg:state_scan instead.")
  (state_scan m))

(cl:ensure-generic-function 'state_load-val :lambda-list '(m))
(cl:defmethod state_load-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:state_load-val is deprecated.  Use pitakuru-msg:state_load instead.")
  (state_load m))

(cl:ensure-generic-function 'state_shelf-val :lambda-list '(m))
(cl:defmethod state_shelf-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:state_shelf-val is deprecated.  Use pitakuru-msg:state_shelf instead.")
  (state_shelf m))

(cl:ensure-generic-function 'state_navigation-val :lambda-list '(m))
(cl:defmethod state_navigation-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:state_navigation-val is deprecated.  Use pitakuru-msg:state_navigation instead.")
  (state_navigation m))

(cl:ensure-generic-function 'costmap-val :lambda-list '(m))
(cl:defmethod costmap-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:costmap-val is deprecated.  Use pitakuru-msg:costmap instead.")
  (costmap m))

(cl:ensure-generic-function 'side_joystick-val :lambda-list '(m))
(cl:defmethod side_joystick-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:side_joystick-val is deprecated.  Use pitakuru-msg:side_joystick instead.")
  (side_joystick m))

(cl:ensure-generic-function 'ctrl_front-val :lambda-list '(m))
(cl:defmethod ctrl_front-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:ctrl_front-val is deprecated.  Use pitakuru-msg:ctrl_front instead.")
  (ctrl_front m))

(cl:ensure-generic-function 'ctrl_side-val :lambda-list '(m))
(cl:defmethod ctrl_side-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:ctrl_side-val is deprecated.  Use pitakuru-msg:ctrl_side instead.")
  (ctrl_side m))

(cl:ensure-generic-function 'trackeds-val :lambda-list '(m))
(cl:defmethod trackeds-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:trackeds-val is deprecated.  Use pitakuru-msg:trackeds instead.")
  (trackeds m))
