...
(cl:defmethod cl:initialize-instance :after ((m <DriveWheel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveWheel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pitakuru-msg:<DriveWheel> is deprecated: use pitakuru-msg:DriveWheel instead.")))

(cl:ensure-generic-function 'left_rpm-val :lambda-list '(m))
(cl:defmethod left_rpm-val ((m <DriveWheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:left_rpm-val is deprecated.  Use pitakuru-msg:left_rpm instead.")
  (left_rpm m))

(cl:ensure-generic-function 'right_rpm-val :lambda-list '(m))
(cl:defmethod right_rpm-val ((m <DriveWheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pitakuru-msg:right_rpm-val is deprecated.  Use pitakuru-msg:right_rpm instead.")
  (right_rpm m))
