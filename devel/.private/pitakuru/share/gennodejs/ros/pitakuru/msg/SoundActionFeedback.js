...
class SoundActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SoundFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SoundFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SoundActionFeedback(null);
    ...
    data.feedback = SoundFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SoundActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SoundFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SoundFeedback()
    }
...
module.exports = SoundActionFeedback;
