// Generated by gencpp from file pitakuru/State.msg
// DO NOT EDIT!


#ifndef PITAKURU_MESSAGE_STATE_H
#define PITAKURU_MESSAGE_STATE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::pitakuru::State_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::pitakuru::State_<ContainerAllocator> const> ConstPtr;

}; // struct State_

typedef ::pitakuru::State_<std::allocator<void> > State;

typedef boost::shared_ptr< ::pitakuru::State > StatePtr;
typedef boost::shared_ptr< ::pitakuru::State const> StateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::pitakuru::State_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::pitakuru::State_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::pitakuru::State_<ContainerAllocator1> & lhs, const ::pitakuru::State_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::pitakuru::State_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::pitakuru::State_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::pitakuru::State_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::pitakuru::State_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::pitakuru::State_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::pitakuru::State_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::pitakuru::State_<ContainerAllocator> >
{
  ...
  static const char* value(const ::pitakuru::State_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1d1d2a87dda45fe2ULL;
  static const uint64_t static_value2 = 0xcfd2df8cea1145d9ULL;
};

template<class ContainerAllocator>
struct DataType< ::pitakuru::State_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::pitakuru::State_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# シャットダウン（非通電）\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::pitakuru::State_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::pitakuru::State_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::pitakuru::State_<ContainerAllocator>& v)
  {
    s << indent << "state: ";
...
#endif // PITAKURU_MESSAGE_STATE_H
