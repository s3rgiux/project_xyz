...
"""autogenerated by genpy from pitakuru/SoundAction.msg. Do not edit."""
import codecs
import sys
...
class SoundAction(genpy.Message):
  _md5sum = "7f3e7e137923c3cbd3fe9f2e5d55cc86"
  _type = "pitakuru/SoundAction"
...
"""
  ...
  _slot_types = ['pitakuru/SoundActionGoal','pitakuru/SoundActionResult','pitakuru/SoundActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = pitakuru.msg.SoundActionGoal()
      if self.action_result is None:
        self.action_result = pitakuru.msg.SoundActionResult()
      if self.action_feedback is None:
        self.action_feedback = pitakuru.msg.SoundActionFeedback()
    else:
      self.action_goal = pitakuru.msg.SoundActionGoal()
      self.action_result = pitakuru.msg.SoundActionResult()
      self.action_feedback = pitakuru.msg.SoundActionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.type = str[start:end]
      _x = self
      start = end
      end += 12
