...
"""autogenerated by genpy from pitakuru/SoundActionResult.msg. Do not edit."""
import codecs
import sys
...
class SoundActionResult(genpy.Message):
  ...
  _type = "pitakuru/SoundActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pitakuru/SoundResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pitakuru.msg.SoundResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pitakuru.msg.SoundResult()
