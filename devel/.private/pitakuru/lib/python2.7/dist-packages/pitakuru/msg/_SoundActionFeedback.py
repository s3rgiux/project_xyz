...
"""autogenerated by genpy from pitakuru/SoundActionFeedback.msg. Do not edit."""
import sys
...
class SoundActionFeedback(genpy.Message):
  ...
  _type = "pitakuru/SoundActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pitakuru/SoundFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = pitakuru.msg.SoundFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pitakuru.msg.SoundFeedback()
