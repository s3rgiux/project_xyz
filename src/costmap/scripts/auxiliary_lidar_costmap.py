...
class image_converter:
  ...
  def callbackLaser(self, msg):
    ...
    if self.low_speed:
      ...
      self.cost_d.x=np.sum(res)/460000 #2000.0##/271320.0#/222870.0#/222360.0#/222870.0#/122145.0#/76245.0#/58140.0
    else:
      ncentery=125#112#mask10
      ncenterx=105
      crop_img = cost2[ncentery-20:ncentery+20, ncenterx-18:ncenterx+18] #mask10
      res=self.mask10*crop_img
      self.cost_d.x=np.sum(res)/551000 #2200.0##/271320.0#/222870.0#/222360.0#/222870.0#/122145.0#/76245.0#/58140.0
