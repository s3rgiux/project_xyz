...
class PitWheels:
    def __init__(self):
        ...
        self.pcon = pyproacmd.ProaCmd('/dev/serial/by-id/usb-STMicroelectronics_STM32_STLink_066DFF343537424257251748-if02', baud)
        self.pcon2 = pyproacmd.ProaCmd('/dev/serial/by-id/usb-STMicroelectronics_STM32_STLink_0669FF343537424257252431-if02', baud)
