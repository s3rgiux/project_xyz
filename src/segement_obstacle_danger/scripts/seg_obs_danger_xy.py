...
class SegmentExtractor:
    ...
    def obstacles_callback(self, data):
        ...
        for circle in data.circles:
            #print("circle {},{}".format(circle.center.x,circle.center.y))
        ...
        for segment in data.segments:
            #print("segment_found init {},{} fin {},{}".format(segment.first_point.x ,segment.first_point.y ,segment.last_point.x,segment.last_point.y))
