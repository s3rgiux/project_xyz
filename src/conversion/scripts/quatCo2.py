...
class QuatToEuler():
	...
	self.euler_msg = Float64()

        # Create subscribers and publishers.
        #sub_imu   = rospy.Subscriber("imu", Imu, self.imu_callback)
        sub_odom  = rospy.Subscriber("poseupdate", PoseWithCovarianceStamped, self.odom_callback)
        pub_euler = rospy.Publisher("euler2", Float64)
	...
	self.euler_msg.data=(y*180)/3.1416
